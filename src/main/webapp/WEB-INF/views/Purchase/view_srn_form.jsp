...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring"%>
 <head>
   ...
   function viewSRN(srnNo) {
		$.ajax({
		url : "${pageContext.request.contextPath}/addsrn/viewSrnByNO",
		type : "POST",
		data : "srnNo=" + srnNo,
					...
					<tbody>
						<c:forEach items="${srnList}" var="srnObj"
							...
							<tr>
								...
								<td>${srnObj.projectobj.projectname}</td>
								<td><a href="#" onClick="viewSRN('${srnObj.srnNumber}')">${srnObj.srnNumber}</a></td>
								<td>${srnObj.srnDate}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
