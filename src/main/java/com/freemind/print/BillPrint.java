        ...
        public void addBillDetails(Sale sale) {
            try {
                ...
                for (SaleDetails saleDetails:sale.getListSaleDetails()) {
                    BillDetails billDetails = new BillDetails("" + (i + 1), saleDetails.getProduct().getProductName(), saleDetails.getQuantity(), saleDetails.getProduct().getSaleRate(), saleDetails.getQuantity()*saleDetails.getProduct().getSaleRate());
